...
import com.apm.agent.context.trace.TraceSegment;
import com.apm.agent.util.StringUtil;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import static com.apm.agent.conf.Config.Agent.OPERATION_NAME_THRESHOLD;
...
//                }
                context = new TracingContext(operationName);    //EXTEND_SERVICE.createTraceContext(operationName, forceSampling);
